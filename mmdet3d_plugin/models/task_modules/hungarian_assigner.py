...
class HungarianAssignerCustom(BaseAssigner):
    ...
    def assign(self,
        ...
        # send pred_instances.pred_bboxes to CPU
        device = gt_instances.bboxes.device
        pred_instances = pred_instances.to(device)
        bboxes, gt_bboxes = pred_instances.bboxes, gt_instances.bboxes
        
        for match_cost in self.match_costs:
            if match_cost.__class__.__name__ == 'IoUCost':
                cost = match_cost(
